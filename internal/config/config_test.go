...
func TestNewOperatorConfig(t *testing.T) {
	...
	assert.True(t, cfg.Providers.Subroutines.Providers.Workspace.Enabled)
	assert.True(t, cfg.Providers.Subroutines.Providers.Kubeconfig.Enabled)
}
...
func TestOperatorConfigAddFlagsProviders(t *testing.T) {
	...
	err := fs.Parse([]string{
		...
		"--subroutines-providers-workspace-enabled=false",
		"--subroutines-providers-kubeconfig-enabled=false",
	})
	...
	assert.False(t, cfg.Providers.Subroutines.Providers.Workspace.Enabled)
	assert.False(t, cfg.Providers.Subroutines.Providers.Kubeconfig.Enabled)
}
